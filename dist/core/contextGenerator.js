 ...
 */
export async function generateAIContext(repoMap, summary, options = {}) {
 ...
 */
async function callModel(model, variant, systemPrompt, userPrompt, repoMapData, summaryData) {
    try {
 ...
 */
function generateBasicAnalysis(map, sum) {
    ...
    if (dirs.some(d => d.includes("src/")))
        architecture = "Nested module structure";
    return `# AI Context
...
export function generateCurrentFocus() {
