...
/**
 * Result of framework instruction generation
 */
...
/**
 * Detect frameworks from files using techStack detection
 */
...
/**
 * Generate Django-specific instructions
 */
...
/**
 * Generate Rails-specific instructions
 */
...
- **Helpers**: Keep view logic in helper modules
- **Partials**: Use partials (\`_partial.html.erb\`) for reusable view components
- **Assets**: Use the Asset Pipeline or Webpacker for JavaScript/CSS
...
- **Validations**: Use ActiveRecord validations (\`validates :field, presence: true\`)
- **Associations**: Define relationships (\`belongs_to\`, \`has_many\`, \`has_one\`)`;
}

/**
 * Generate Laravel-specific instructions
 */
...
/**
 * Generate Express-specific instructions
 */
...
/**
 * Generate NestJS-specific instructions
 */
...
/**
 * Generate Spring Boot-specific instructions
 */
...
/**
 * Generate FastAPI-specific instructions
 */
...
/**
 * Generate Flask-specific instructions
 */
...
/**
 * Generate framework-specific instructions for ai_rules.md
 */
